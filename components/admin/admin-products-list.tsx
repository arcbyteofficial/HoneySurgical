  ...
  return (
    <div className="rounded-lg border border-border bg-white p-5 shadow-sm">
      ...
      {filteredProducts.length === 0 ? (
        <div className="py-8 text-center border border-dashed border-border rounded-lg bg-secondary/10">
            ...
            {filteredProducts.map((product) => (
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-2 text-xs border-t border-border/40 pt-2.5 mt-1">
                  <div>
                    <span className="block text-[10px] text-muted-foreground uppercase tracking-wider font-semibold mb-0.5">
                      SKU / Brand
                    </span>
                    <span className="font-mono text-muted-foreground select-all text-[11px] block">
                      {product.sku}
                    </span>
                  ...
                  <div>
                    ...
                    <div className="mb-1">
                      <Badge
                        variant="beige"
                        className="text-[9px] bg-medical-bluePale/30 text-medical-deep border border-medical-blue/20"
                      >
                        {product.category.name}
                      </Badge>
                    </div>
